...
![Tests](https://img.shields.io/badge/backend-82%20passing-brightgreen)
...
| Backend test run                       | **82 passed**                           |
| Unit test coverage                     | **94.08%**                              |
...
- Anything else falls through to the configured LLM provider
...
├── tests/                        # 82 backend tests plus Selenium Chrome smoke tests
...
- **Added configurable LLM providers**: free mock default, optional Gemini, OpenAI or Ollama
...
- **Added test suite**: 82 backend tests, Selenium Chrome smoke tests, 94% coverage, CI-gated at 80%
